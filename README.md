...
Just add `"com.fofanius.unity-type-interface-reference":"https://gitea.fofanius.online/fofanius/unity-type-interface-reference.git#VERSION"` line to your project `manifest.json` file.
...
{
  "dependencies": {
    "com.fofanius.unity-type-interface-reference": "https://gitea.fofanius.online/fofanius/unity-type-interface-reference.git#1.1.0"
  }
}
```